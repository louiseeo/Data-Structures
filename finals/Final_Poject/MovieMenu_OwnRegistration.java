...
public class MovieMenu_OwnRegistration {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 6:
                    ...
                    break;
                case 0:
                    FileLogger.log("Thank you for using the Movie Registration System!");
                    FileLogger.log("Exiting program...");
                    break;
                default:
                    FileLogger.log("Invalid input! Enter a valid choice.");
            }
    ...
    public static void addMovies() {
        ...
        FileLogger.logAnswer("Enter title: " + title);
        movie.add(title);
        System.out.print("Enter year released: ");
        String year = sc.nextLine();
        FileLogger.logAnswer("Enter year released: " + year);
        movie.add(year);
        System.out.print("Enter genre: ");
        String genre = sc.nextLine();
        FileLogger.logAnswer("Enter genre: " + genre);
        movie.add(genre);
        System.out.print("Enter duration(e.g., 2h 30m): ");
        String duration = sc.nextLine();
        FileLogger.logAnswer("Enter duration(e.g., 2h 30m): " + duration);
        movie.add(duration);
        System.out.print("Enter name of director: ");
        String director = sc.nextLine();
        FileLogger.logAnswer("Enter name of director: " + director);
        movie.add(director);
    ...
    public static void searchMovie() {
        ...
        FileLogger.log("\n---- Movie Found ----");
        FileLogger.log("Title: " + movie.get(start));
        FileLogger.log("Year : " + movie.get(start + 1));
        FileLogger.log("Genre: " + movie.get(start + 2));
        FileLogger.log("Duration: " + movie.get(start + 3));
        FileLogger.log("Director: " + movie.get(start + 4));
    }
    ...
    public static void editMovie() {
        ...
        FileLogger.logAnswer("Do you want to edit this movie? (y/n): " + ans);
       ...
       do {
            ...
            if (!sc.hasNextInt()) {
                FileLogger.log("Invalid input! Try again.");
                sc.nextLine();
                continue;
            }
            ...
            if (choice < 1 || choice > 5) {
                FileLogger.log("Invalid choice! Pick again.");
                continue;
            }
            ...
            FileLogger.logAnswer("Enter new value: " + newVal);
    ...
    public static void deleteMovie() {
        ...
        while (true) {
            ...
            String ans = sc.nextLine();
            FileLogger.logAnswer("Do you want to delete this movie? (y/n): " + ans);
            if (!ans.equalsIgnoreCase("y")) {
                return;
            }
    ...
    public static void sortMovies() {
        ...
        while (true) {
            ...
            if (!sc.hasNextInt()) {
                FileLogger.log("Invalid input! Enter a number.\n");
                sc.nextLine();
                continue;
            }
            choice = sc.nextInt();
            ...
            if (choice == 1 || choice == 2) {
                ...
                FileLogger.log("Invalid choice! Pick between 1 or 2.\n");
            }
        }
        int m = movie.size();
    ...
    public static void displayList() {
        if (movie.isEmpty()) {
            FileLogger.log("No movies found in the list.");
            return;
        }
        ...
        FileLogger.log(
                "+----+------------------------------+------+-------------------------+----------+----------------------+");
        FileLogger.logf("| %-2s | %-28s | %-4s | %-23s | %-8s | %-20s |%n",
        ...
        for (int i = 0; i < movie.size(); i += 5) {
            FileLogger.logf("| %-2d | %-28s | %-4s | %-23s | %-8s | %-20s |%n",
                    movieCount,
                    movie.get(i), // Title
                    movie.get(i + 1), // Year
                    movie.get(i + 2), // Genre
    ...
    public static void saveMovies() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(filename))) {
            ...
            FileLogger.log("Error saving movies: " + e.getMessage());
        }
    }
    ...
    public static int getMovieStartIndex() {
        while (true) {
            ...
            FileLogger.log("Available movies: " + movie.size() / 5);
    ...
    public static boolean isMovieListEmpty() {
        if (movie.isEmpty()) {
            FileLogger.log("Movie list is empty.");
            return true;
        }
        return false;
    }
